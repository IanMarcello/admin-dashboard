...
<template>
  <div
    class="flex flex-col justify-center min-h-screen py-6 sm:px-6 lg:px-8 bg-contain bg-no-repeat bg-left bg-[url('@/assets/images/vergil1.png')] dark:bg-slate-900"
  >
